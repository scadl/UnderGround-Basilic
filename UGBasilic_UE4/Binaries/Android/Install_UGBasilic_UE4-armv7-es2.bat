...
%ADB% %DEVICE% uninstall net.scadsdnd.UGBasilic_UE4
@echo.
@echo Installing existing application. Failures here indicate a problem with the device (connection or storage permissions) and are fatal.
%ADB% %DEVICE% install UGBasilic_UE4-armv7-es2.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/UGBasilic_UE4
...
%ADB% %DEVICE% shell pm grant net.scadsdnd.UGBasilic_UE4 android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant net.scadsdnd.UGBasilic_UE4 android.permission.WRITE_EXTERNAL_STORAGE
@echo.
